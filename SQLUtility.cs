...
namespace CPUFramework
{
    public class SQLUtility
    {
        ...
        private static DataTable DoExicuteSQL(SqlCommand cmd, bool loadtable)
        {
        ...
        {
            return DoExicuteSQL(new SqlCommand(sqlstatement),true);
        }
